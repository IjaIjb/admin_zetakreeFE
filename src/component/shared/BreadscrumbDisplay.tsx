...
const BreadscrumbDisplay = () => {
  ...
  return (
    <div>
      <div className="pb-2 text-white flex items-center gap-4">
        ...
        <div>
          <h1 className="font-[700] md:text-[24px] text-[18px] leading-4 text-white">
            {lastPathname
              ? capitalizeFirstLetter(
                  lastPathname.split("%20").join(" ").toLowerCase() ===
                    "Overview"
                    ? "dashboard"
